...
// 4. So basically, Its a wayu to pass data from a parent component to child component.
// 5. Parent components can pass props to their child components, but not the other way around.
// 6. Props can be many data types, including: Numbers, Strings, Functions, Objects
